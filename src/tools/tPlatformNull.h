...
#ifndef ArmageTron_PlatformNull_H
#define ArmageTron_PlatformNull_H

#include "tPlatform.h"

//! Null platform implementation for dedicated server builds.
//! Uses native OS APIs for timing and sleep, no SDL dependency.
class tPlatformNull : public tPlatform
{
public:
    tPlatformNull();
    ~tPlatformNull() override;
...
#endif // ArmageTron_PlatformNull_H
