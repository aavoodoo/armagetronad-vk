/* tUniversalVariables.h — Android build
 * On Android, paths are managed via SDL_GetPrefPath() and APK assets.
...
#endif
#ifndef EXEC_PREFIX
    #define EXEC_PREFIX "/data/local/tmp"
#endif
#ifndef BINDIR
    #define BINDIR "/data/local/tmp/bin"
#endif
#ifndef SBINDIR
    #define SBINDIR "/data/local/tmp/sbin"
#endif
#ifndef DATADIR
    #define DATADIR "."
#endif
